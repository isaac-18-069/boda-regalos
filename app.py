...
<style>
    ...
    /* Esquinas Florales Decorative SVGs */
    .flower-top-left {
        position: absolute;
        top: -10px;
        left: -10px;
...
# SVG de Flores/Rosas para las esquinas
FLOWER_SVG = """
<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 10C30 15 40 35 30 55C20 40 5 30 10 10Z" fill="#A4C3B2" opacity="0.7"/>
    <path d="M15 5C35 20 45 45 25 65C20 45 5 25 15 5Z" fill="#C4D7D1" opacity="0.6"/>
    <circle cx="45" cy="45" r="18" fill="#E8B4B8" opacity="0.85"/>
    <circle cx="42" cy="42" r="12" fill="#D88A92" opacity="0.9"/>
    <circle cx="40" cy="40" r="6" fill="#B55B65"/>
    <circle cx="65" cy="30" r="12" fill="#F4C2C2" opacity="0.8"/>
    <circle cx="63" cy="28" r="8" fill="#E8B4B8"/>
</svg>
"""
...
# ──────────────────────────────────────────────
# PASO 2: VISTA DE TARJETA CON ROSAS Y FOTO
# ──────────────────────────────────────────────
    ...
    <div class="card-invitation">
        <div class="flower-top-left">{FLOWER_SVG}</div>
        <div class="flower-bottom-right">{FLOWER_SVG}</div>
        
        <div class="boda-subtitulo">NUESTRA BODA</div>
        <div class="boda-nombres">Carlos & Eunice</div>
        <div class="boda-fecha">18 • 07 • 2027</div>
        
        {img_html}
        
        <p style="font-style: italic; color: #4A5568; margin-top: 15px;">
